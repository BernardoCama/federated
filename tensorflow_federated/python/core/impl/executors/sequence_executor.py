...
class _SequenceFromPayload(_Sequence):
  ...
  def __init__(self, payload, type_spec):
    ...
    try:
      ...
      raise NotImplementedError('Unrecognized type of payload: {}'.format(
          py_typecheck.type_string(type(payload))))
...
class _SequenceFromMap(_Sequence):
  ...
  def __init__(self, source, map_fn, target_executor, type_spec):
...
class _AsyncMapIterator(object):
  ...
  def __init__(self, source, map_fn, target_executor):
...
async def _delegate(val, type_spec, target_executor):
...
class SequenceExecutorValue(executor_value_base.ExecutorValue):
  ...
  def __init__(self, value, type_spec):
    ...
    * An instance of `_SequenceOp` for an instrinsic among one of the
      `_SUPPORTED_INTRINSICS` to represent the supported sequence intrinsics.
...
class SequenceExecutor(executor_base.Executor):
  ...
  async def create_call(self, comp, arg=None):
    ...
    raise NotImplementedError(
        'Unsupported functional representation of type {}.'.format(
